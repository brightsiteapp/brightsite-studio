...
function templateDesignCSS() {
  ...
  @media(max-width:760px){
    ...
    .layout-minimal .reviews,.layout-bold .reviews,.layout-luxe .reviews,.layout-kinetic .reviews,.layout-editorial .reviews,.layout-serene .reviews,.layout-organic .reviews,.layout-soft .reviews{grid-template-columns:1fr;gap:12px}
    .layout-kinetic .review-card:nth-child(n){padding:18px}
    .layout-minimal .gallery{grid-template-columns:1fr 1fr;gap:12px}
    .layout-minimal .review-card:nth-child(n){padding:16px}.layout-minimal .review-card blockquote{font-size:19px}
    .layout-editorial .review-card:nth-child(n){padding:20px 0}.layout-editorial .review-card blockquote{font-size:22px!important}.layout-editorial .review-card:first-child blockquote{font-size:26px!important}
    .layout-bold blockquote{font-size:22px!important}.layout-bold .review-card:nth-child(n){padding:20px}
    .layout-luxe .review-card:nth-child(n){padding:20px}.layout-luxe .review-card blockquote{font-size:22px}
    .layout-kinetic .review-card blockquote{font-size:22px!important}.layout-kinetic .review-card:first-child blockquote{font-size:clamp(24px,7vw,34px)!important}
    .layout-serene .review-card:nth-child(n){padding:20px}.layout-serene .review-card blockquote{font-size:22px}
    .layout-organic .review-card:nth-child(n){padding:18px}.layout-organic .review-card blockquote{font-size:19px}
    .layout-soft .review-card:nth-child(n){padding:20px}
    .content-creative .review-card{grid-template-columns:1fr!important;gap:8px!important;padding:16px 0!important}.content-creative blockquote,.content-creative .review-card:first-child blockquote{font-size:18px!important}
  }
...
function sereneLayoutCSS() {
  ...
  .layout-serene .brand{font-family:var(--heading);font-weight:500;font-style:italic}
  @media(min-width:761px){.layout-serene .brand{font-size:32px}}
...
function editorialStudioCSS() {
  ...
  .layout-editorial .brand{font-family:var(--heading);font-weight:400}
  @media(min-width:761px){.layout-editorial .brand{font-size:30px}}
...
function noirLayoutCSS() {
  ...
  .layout-bold .brand{font-family:var(--heading);font-weight:400}
  @media(min-width:761px){.layout-bold .brand{font-size:32px}}
...
function lumeLayoutCSS() {
  ...
  .layout-lume .brand{font-family:var(--heading);font-weight:500}.layout-lume .nav{font-size:10px;text-transform:uppercase;letter-spacing:.14em}
  @media(min-width:761px){.layout-lume .brand{font-size:30px}}
...
function studioProLayoutCSS() {
  ...
  .layout-studio .site-header{background:var(--bg);border-bottom:2px solid var(--ink)}.layout-studio .brand{font-family:var(--heading);text-transform:uppercase;letter-spacing:.02em}.layout-studio .nav{text-transform:uppercase;font-size:10px;letter-spacing:.12em}.layout-studio .button{border-radius:0;background:var(--ink);border:2px solid var(--ink);color:var(--bg);text-transform:uppercase;letter-spacing:.1em;font-size:11px}
  @media(min-width:761px){.layout-studio .brand{font-size:28px}}
